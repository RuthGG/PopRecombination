...
# args[4]<-"analysis/defTest_LocationPatterns/04_MapValidityTest/recombinationMap_sliding/fillWindowMeasurements/Spencemap_sliding/windowData.txt" # POP map in sliding windows made without repeat regions
# args[5]<-"analysis/defTest_LocationPatterns/04_MapValidityTest/recombinationMap_sliding/fillWindowMeasurements/Bherermap_sliding/windowData.txt" # PED map in sliding windows made without repeat regions
# args[6]<-outfile
...
# QUANTILE OF MIN AND MAX RATIO BETWEEN MAPS INSIDE INV
  ...
  observedRatio$maxFC_pval<-nullRatioMin(observedRatio$maxFC)
