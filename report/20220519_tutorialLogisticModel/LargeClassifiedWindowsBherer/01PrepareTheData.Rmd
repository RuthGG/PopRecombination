...
$ENVPY code/python/divideChromosomes.py \
  ...
  -b data/cytoBand.txt -f 0 -s 0.05 -r 800000 -o $OUTDIR -d avgBherer
```

```{bash, include=showcode, eval=runbash}
cd /home/rgomez/Documents/PHD_Repos/20211117_PopRecombination/report/20220519_tutorialLogisticModel/    
```
...
```{bash, include=showcode, eval=runbash}
ENVPY="/home/rgomez/anaconda3/bin/python"
NAME="LargeClassifiedWindowsBherer"
cd "../../../"
