...
$ENVPY code/python/divideChromosomes.py \
  ...
  -b data/cytoBand.txt -f 0 -s 0.03 -r 1000000 -o $OUTDIR -d femBherer 
...
name <-"femBherer_COzones_0.05_800000"
...
```{r SizeOutliers, eval=runR,echo=showcode, fig.cap="Size distribution of windows" ,  fig.height=6}
...
```
```{r SizeOutliers2, eval=runR,echo=showcode, fig.cap="Size distribution of new windows" ,  fig.height=6}
