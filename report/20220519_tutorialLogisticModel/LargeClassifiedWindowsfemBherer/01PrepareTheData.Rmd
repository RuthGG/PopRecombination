...
OUTDIR="report/20220519_tutorialLogisticModel/LargeClassifiedWindowsfemBherer/data"

$ENVPY code/python/divideChromosomes.py \
  -m data/Bherer_Refined_genetic_map_b37_processed/female_allChr.bed \
  -b data/cytoBand.txt -f 0 -s 0 -r 800000 -o $OUTDIR -d femBherer

cd /home/rgomez/Documents/PHD_Repos/20211117_PopRecombination/report/20220519_tutorialLogisticModel/LargeClassifiedWindowsfemBherer   
```
...
name <-"femBherer_COzones_0.0_800000"
...
```{bash, include=showcode, eval=runbash}
ENVPY="/home/rgomez/anaconda3/bin/python"
NAME="LargeClassifiedWindowsfemBherer"
cd "../../../"
$ENVPY code/python/fillWindowMeasurements.py -m data/Bherer_Refined_genetic_map_b37_processed/female_allChr.bed -w report/20220519_tutorialLogisticModel/${NAME}/data/windows.txt  -o report/20220519_tutorialLogisticModel/${NAME}/data/ -d "chromRegions"
